...
set(RETROROOT TRUE)
set(RETROROOT_SYSROOT "${RETROROOT_HOME}/target/aarch64")
...
set(CMAKE_LIBRARY_ARCHITECTURE aarch64 CACHE INTERNAL "abi")
set(CMAKE_SYSROOT ${RETROROOT_SYSROOT})
set(CMAKE_POSITION_INDEPENDENT_CODE ON)

# toolchain setup
set(RETROROOT_HOST "${RETROROOT_HOME}/host/aarch64")
...
find_program(PKG_CONFIG_EXECUTABLE NAMES aarch64-linux-gnu-pkg-config HINTS "${RETROROOT_SYSROOT}/usr/bin")
if (NOT PKG_CONFIG_EXECUTABLE)
  message(WARNING "Could not find aarch64-linux-gnu-pkg-config: try installing rr-pkg-config")
endif ()
